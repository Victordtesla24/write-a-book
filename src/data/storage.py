...
class StorageManager:
    ...
    def save_file(self, relative_path: str, content: Union[str, Dict[str, Any]]) -> None:
    ...
    def load_file(self, relative_path: str, as_json: bool = False) -> Union[str, Dict[str, Any]]:
