"""Book Editor main module.

This module provides the main functionality for the Book Editor application,
including the editor interface, template management, and preview functionality.
"""
...
def main():
    ...
    with col2:
        render_preview(st.session_state.get("editor_content", ""))
